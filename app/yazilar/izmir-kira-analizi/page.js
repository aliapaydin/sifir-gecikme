  ...
  return (
    <main className="min-h-screen">
      ...
      <article className="max-w-3xl mx-auto px-6 py-12 prose-article">
        ...
        <p>
          İzmir'de ev aramak artık farklı bir spor. Bir ilan açıyorsun, iki gün sonra fiyat değişmiş. Üç ay önce uygun olan ilçe bütçenin dışına çıkmış. "Çeşme pahalıdır" diyorsun, Urla'ya bakıyorsun, orası da öyle. Peki hangi ilçe gerçekten değerli, hangisi sadece büyük?
        </p>

        <p>
          Veriyi açalım ve bakalım. Kaggle'daki <strong>İzmir Konut Fiyatları 2024</strong> datasetinden 5.841 ilan, 4.211 temizlenmiş daire kaydıyla çalıştık.
        </p>

        <h2>Veriyi Tanıyalım</h2>
        <p>
          Dataset şu sütunları içeriyor: gayrimenkul tipi, fiyat, oda sayısı, salon, alan (m²), bina yaşı, il ve ilçe. Eksik değer yok, veri oldukça temiz gelmiş. Aykırı değerleri temizlemek için fiyatın 1. ve 99. yüzdelik dilimini kestik — yani 1.3M TL altı ve 16.5M TL üstü ilanlar dışarıda.
        </p>
...
print(f"Temiz kayıt sayısı: {len(daire)}")  # 4211`}</pre>
        ...
        <p>
          Ham fiyat sıralamalarına bakınca Güzelbahçe, Çeşme ve Narlıdere üst sıralarda. Ama bu sıralama biraz yanıltıcı çünkü büyük daireler her zaman pahalıdır. Daha adil karşılaştırma için <strong>m² başına fiyata</strong> bakmak gerekiyor.
        </p>

        <img src="/izmir-kira/01_ilce_medyan_fiyat.png" alt="İzmir ilçe medyan fiyatları" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0', border: '0.5px solid var(--color-border)' }} />

        <h2>Asıl Soru: m² Başına Fiyat</h2>
        <p>
          İşte ilginç olan burada. m² bazında baktığımızda tablo değişiyor: <strong>Çeşme 68.750 TL/m²</strong> ile açık ara birinci. Urla (60.968), Güzelbahçe (56.071) ve Narlıdere (47.318) takip ediyor. Karşıyaka ise medyan fiyatta yüksek görünse de m² bazında orta pakette kalıyor — çünkü Karşıyaka daireleri genellikle büyük.
        </p>

        <img src="/izmir-kira/02_m2_fiyati.png" alt="İzmir ilçe m² fiyatları" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0', border: '0.5px solid var(--color-border)' }} />

        <blockquote style={{ borderLeft: '3px solid var(--color-accent)', paddingLeft: '20px', margin: '2rem 0' }}>
          <p style={{ fontStyle: 'italic', marginBottom: 0 }}>
            En uygun m² fiyatı Tire (22.222 TL) ve Ödemiş'te (19.346 TL). Merkez ilçelerin üçte biri. Şehir merkezine uzaklığın bedeli net görünüyor.
          </p>
        </blockquote>

        <h2>Oda Sayısı Fiyatı Ne Kadar Etkiliyor?</h2>
        <p>
          Beklediğimiz gibi oda sayısı arttıkça fiyat artıyor. Ama dikkat çekici olan şey kutu grafiğindeki geniş aralıklar: aynı oda sayısına sahip daireler arasında 2-3 kat fiyat farkı olabiliyor. Demek ki "3+1" demek tek başına pek bir şey söylemiyor.
        </p>

        <img src="/izmir-kira/03_oda_fiyat.png" alt="Oda sayısı fiyat dağılımı" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0', border: '0.5px solid var(--color-border)' }} />

        <h2>Alan mı, Oda mı, Yaş mı — Fiyatı Ne Belirliyor?</h2>
        <p>
          Korelasyon analizine bakınca alanın fiyatla ilişkisi (0.49) oda sayısından (0.31) çok daha güçlü. Bina yaşı ise şaşırtıcı şekilde zayıf bir etki gösteriyor (-0.08). Yani "kaç odalı" değil <strong>"kaç m²"</strong> sorusu fiyatı asıl belirleyen faktör.
        </p>

        <img src="/izmir-kira/04_alan_fiyat_scatter.png" alt="Alan fiyat ilişkisi scatter plot" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0', border: '0.5px solid var(--color-border)' }} />

        <h2>Yeni Bina Farkı Gerçek mi?</h2>
        <p>
          Evet, gerçek. 0-5 yaş binalarda m² fiyatı en yüksek, sonra belirgin bir düşüş var. Ama ilginç olan şu: 6-10 ile 11-15 yıl arası binalarda m² fiyatı neredeyse aynı. Yani biraz eski bina almak mantıklı olabilir, çok eski bina ise fiyatı önemli ölçüde düşürüyor.
        </p>

        <img src="/izmir-kira/05_yas_m2.png" alt="Bina yaşı m² fiyat ilişkisi" style={{ width: '100%', borderRadius: '8px', margin: '1.5rem 0', border: '0.5px solid var(--color-border)' }} />

        <h2>Basit Bir Model: Fiyat Tahmin Edebilir miyiz?</h2>
        <p>
          Alan, oda sayısı ve bina yaşını kullanarak linear regression modeli kurduk. Sonuç: <strong>R² = 0.27.</strong> Yani bu üç değişken fiyat değişiminin yalnızca %27'sini açıklayabiliyor.
        </p>
...
# 100m², 3+1, 10 yaş daire tahmini: ~3.63 milyon TL`}</pre>
        ...
        <blockquote style={{ borderLeft: '3px solid var(--color-accent)', paddingLeft: '20px', margin: '2rem 0' }}>
          <p style={{ fontStyle: 'italic', marginBottom: 0 }}>
            Geri kalan %73 nerede? İlçe, kat, manzara, ulaşım, sosyal donatı, pazarlık payı... Sayıların söylemediği her şey orada. İyi bir modelin sınırını bilmek, modeli körce kullanmaktan değerlidir.
          </p>
        </blockquote>
        ...
        <p style={{ color: 'var(--color-text-soft)', marginTop: '2.5rem' }}>
          Sıradaki yazıda bu modeli geliştireceğiz: ilçe bilgisini de ekleyip R²'yi ne kadar yukarı çekebileceğimize bakacağız. Spoiler: fark büyük.
        </p>
      </article>
...
git add .
git commit -m "izmir kira analizi + hakkımda sayfası"
git push
...
git commit -m "izmir kira analizi + hakkımda sayfası"
git push
cat > ~/Desktop/sifir_gecikme/app/page.js << 'EOF'
