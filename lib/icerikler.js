export const yazilar = [
  {
    href: '/yazilar/bootstrap-ornekleme',
    icon: 'bootstrap-ornekleme',
    badge: 'interaktif',
    badgeClass: 'badge-interactive',
    borderColor: '#f59e0b',
    baslik: 'Örnekleme & Bootstrap: Belirsizliği Ölç',
    ozet: '85 milyondan 30 kişiyle neden güvenilir sonuç çıkar? Popülasyonu seç, 1000 örneklem çek, bootstrap ile güven aralığı hesapla.',
    meta: 'interaktif · 12 dakika · CLT · Bootstrap · Güven Aralığı',
  },
  {
    href: '/yazilar/sql-join-gorsellestirici',
    icon: 'sql-join',
    badge: 'interaktif',
    badgeClass: 'badge-interactive',
    borderColor: '#14b8a6',
    baslik: 'SQL JOIN Türleri: Görerek Öğren',
    ozet: 'INNER, LEFT, RIGHT, FULL OUTER ve CROSS JOIN — her satırın nereye gittiğini renklerle izle, sonuç tablosu anında güncelleniyor.',
    meta: '10 dakika · INNER · LEFT · RIGHT · FULL · CROSS',
  },
  {
    href: '/yazilar/doviz-altin-tahmini',
    icon: 'doviz-altin',
    badge: 'interaktif',
    badgeClass: 'badge-interactive',
    borderColor: '#f59e0b',
    baslik: 'Döviz & Altın: Korelasyondan Tahminine',
    ozet: 'Gerçek zamanlı kur ve altın verisiyle korelasyon analizi yap, ML modelleri karşılaştır, aylık forecast üret.',
    meta: '18 dakika · Canlı Veri · OLS · Log-Lineer',
  },
  {
  ...
  {
    href: '/yazilar/lojistik-regresyon',
    icon: 'confusion-matrix',
    badge: 'interaktif',
    badgeClass: 'badge-interactive',
    borderColor: '#1D9E75',
    baslik: 'Lojistik regresyon: olasılık sınıflandırıcı',
    ozet: 'Sigmoid eğrisini sürükle, karar sınırını izle. Threshold\'u kaydır, precision-recall dengesi değişsin.',
    meta: '12 dakika',
  },
  {
  ...
  {
    href: '/yazilar/sosyal-medya-turkiye',
    icon: 'sosyal-medya',
    badge: 'vaka çalışması',
    badgeClass: 'badge-case',
    borderColor: '#e8a04a',
    baslik: 'Türkiye sosyal medya davranışı: kim, nerede, ne zaman?',
    ozet: 'Platform tercihleri, saatlik aktivite profili, yaş grubu farkları ve içerik tüketim alışkanlıkları.',
    meta: 'vaka · 14 dakika',
  },
  {
  ...
  {
    href: '/yazilar/sepet-terki',
    icon: 'sepet-terki',
    badge: 'vaka çalışması',
    badgeClass: 'badge-case',
    borderColor: '#e8a04a',
    baslik: 'E-ticaret sepet terki: neden ayrılıyorlar, nasıl geri döndürürsün?',
    ozet: 'Dönüşüm hunisi, kullanıcı profil simülatörü ve gelir kurtarma hesaplayıcı. %70 terk oranını veriyle çöz.',
    meta: 'vaka · 22 dakika',
  },
  {
    href: '/yazilar/banka-fraud',
    icon: 'banka-fraud',
    badge: 'vaka çalışması',
    badgeClass: 'badge-case',
    borderColor: '#e8a04a',
    baslik: 'Banka fraud tespiti: 492 sahte işlemi 284 binden ayır',
    ozet: 'Aşırı dengesiz sınıf, Isolation Forest, SMOTE ve XGBoost ile kredi kartı dolandırıcılığı tespiti. PR-AUC odaklı.',
    meta: 'vaka · 20 dakika',
  },
  {
    href: '/yazilar/pandas-referans',
    icon: 'pandas-ref',
    badge: 'araç',
    badgeClass: 'badge-guide',
    borderColor: '#7F77DD',
    baslik: 'Pandas Hızlı Referans',
    ozet: '35 fonksiyon, Türkçe açıklama, kopyalanabilir kod. Okuma, filtreleme, gruplama, zaman serisi ve daha fazlası.',
    meta: 'araç · cheatsheet',
  },
  {
    href: '/promilmetre',
    icon: 'promilmetre',
    ...
    badgeClass: 'badge-guide',
    borderColor: '#f97316',
    baslik: 'Alkol Promilmetre',
    ozet: "Efes, Yeni Rakı, Tekirdağ, Kavaklidere… Türkiye'de satılan içeceklerle kan alkol seviyeni hesapla. Trafik uyarısı ve AI analizi.",
    meta: 'araç · Widmark formülü',
  },
  {
    href: '/csv',
    icon: 'csv',
  ...
  },
  {
    ...
    badgeClass: 'badge-guide',
    borderColor: '#7F77DD',
    baslik: 'Normal Dağılım & Z-Skor Hesaplayıcı',
    ozet: 'Ortalama ve standart sapma gir, değerin Z-skorunu hesapla. Olasılık alanını dağılım üzerinde canlı gör.',
    meta: 'araç · istatistik',
  },
  {
    href: '/hipotez',
    icon: 'ab-test',
    ...
    badgeClass: 'badge-guide',
    borderColor: '#7F77DD',
    baslik: 'Hipotez Testi Seçici',
    ozet: 'Doğru istatistiksel testi adım adım seç: t-testi, ANOVA, ki-kare veya oran z-testi. Parametreleri gir, p-değerini ve kararı al.',
    meta: 'araç · istatistik',
  },
  {
    href: '/yazilar/veri-bilimi-siteleri',
    baslik: 'Veri Bilimcinin Yer İmleri',
    ozet: '23 site, 5 kategori: öğrenmek, pratik yapmak, veri bulmak, toplulukla takipte kalmak. Her biri kısa notlarla.',
    meta: 'rehber · 23 site',
    badge: 'rehber',
    badgeClass: 'badge-guide',
    kategori: 'rehber',
