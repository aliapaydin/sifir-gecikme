...
export const PRODUCTS = {
  ...
  'ram-corsair-16':  { id:'ram-corsair-16',  category:'ram', brand:'Corsair',    name:'16GB DDR4 3200MHz',        specs:'DDR4 / 3200MHz / 16GB',        buyPrice:780,   unlockDay:7,  icon:'🧩', ramType:'DDR4' },
  ...
  'ssd-crucial-1tb': { id:'ssd-crucial-1tb', category:'ssd', brand:'Crucial',    name:'1TB SATA SSD (BX500)',     specs:'SATA / 1TB',                   buyPrice:580,   unlockDay:4,  icon:'💿' },
  ...
  'mouse-steelseries-rival':  { id:'mouse-steelseries-rival',  category:'mouse', brand:'SteelSeries', name:'Rival 3',               specs:'8500 DPI / Kablolu',           buyPrice:480,   unlockDay:7, icon:'🖱️' },
  ...
  'kb-logitech-g413':  { id:'kb-logitech-g413',  category:'keyboard', brand:'Logitech', name:'G413 SE',            specs:'Mekanik / Alüminyum',      buyPrice:1250, unlockDay:7, icon:'⌨️' },
  ...
  // CPU
  'cpu-amd-r5':   { id:'cpu-amd-r5',   category:'cpu', brand:'AMD',   name:'Ryzen 5 5600',    specs:'6C/12T / AM4',      buyPrice:4400,  unlockDay:4,  icon:'🔲', socket:'AM4',    tdp:65  },
  'cpu-intel-i3': { id:'cpu-intel-i3', category:'cpu', brand:'Intel', name:'Core i3-12100F',  specs:'4C/8T / LGA1700',   buyPrice:3600,  unlockDay:4,  icon:'🔲', socket:'LGA1700',tdp:60  },
  ...
  // Anakart
  'mb-msi-b550':      { id:'mb-msi-b550',      category:'motherboard', brand:'MSI',      name:'B550M Pro-VDH',    specs:'AM4 / DDR4 / mATX',  buyPrice:3400,  unlockDay:4,  icon:'🟩', socket:'AM4',    ramType:'DDR4', formFactor:'mATX', supportedMB:['mATX'] },
  ...
  // GPU
  'gpu-rx-6600':   { id:'gpu-rx-6600',   category:'gpu', brand:'AMD',    name:'RX 6600 8GB',         specs:'8GB GDDR6 / RDNA2',   buyPrice:6500,  unlockDay:4,  icon:'🎮', tdp:132 },
  'gpu-rtx-2060':  { id:'gpu-rtx-2060',  category:'gpu', brand:'NVIDIA', name:'RTX 2060 6GB',        specs:'6GB GDDR6 / Turing',  buyPrice:6800,  unlockDay:4,  icon:'🎮', tdp:160 },
  ...
  'case-nzxt':     { id:'case-nzxt',     category:'case', brand:'NZXT',     name:'H510 Flow',        specs:'ATX / Tempered Glass',   buyPrice:2300, unlockDay:7, icon:'🖥️', formFactor:'ATX', supportedMB:['ATX','mATX'], caseColor:'#f5f5f5', caseAccent:'#333333' },
  ...
  // Monitör
  'mon-aoc-24': { id:'mon-aoc-24', category:'monitor', brand:'AOC',  name:'24G2SP 24" FHD',  specs:'24" / FHD / 165Hz / IPS',     buyPrice:3900,  unlockDay:7,  icon:'🖥️' },
...
export const CORPORATE_COMPANIES = [
  { name: 'TechStar A.Ş.',    emoji: '⭐', color: '#F59E0B' },
  { name: 'DigiMax Ltd.',      emoji: '💎', color: '#0EA5E9' },
  { name: 'NetCore Bilişim',   emoji: '🌐', color: '#3B82F6' },
  { name: 'ProSoft Yazılım',   emoji: '⚙️',  color: '#7F77DD' },
  { name: 'DataFlow A.Ş.',     emoji: '📊', color: '#1D9E75' },
  { name: 'PixelArts Studio',  emoji: '🎨', color: '#EC4899' },
  { name: 'CloudSync Ltd.',    emoji: '☁️',  color: '#94A3B8' },
  { name: 'GameHub E-Spor',    emoji: '🎮', color: '#E24B4A' },
  { name: 'MediTech Sağlık',   emoji: '🏥', color: '#10B981' },
  { name: 'EduNet Eğitim',     emoji: '📚', color: '#e8a04a' },
  { name: 'AlphaNet İletişim', emoji: '📡', color: '#8B5CF6' },
  { name: 'SkyBit Yazılım',    emoji: '🚀', color: '#E24B4A' },
];
