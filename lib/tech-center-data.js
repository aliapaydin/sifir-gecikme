...
export const UNLOCK_CATEGORIES = {
  1: ['ram','ssd','mouse','keyboard','cpu','motherboard','psu','gpu','case','monitor','laptop','headset','webcam'],
};
...
export const CUSTOMER_TYPES = {
  student: {
    ...
    wantedCategories:['ram','ssd','mouse','keyboard','headset'],
  ...
  gamer: {
    ...
    wantedCategories:['gpu','monitor','ram','keyboard','mouse','headset','laptop'],
  ...
  professional: {
    ...
    wantedCategories:['cpu','ram','ssd','monitor','laptop','webcam'],
  ...
  corporate: {
    ...
    wantedCategories:['laptop','monitor','keyboard','mouse','webcam'],
